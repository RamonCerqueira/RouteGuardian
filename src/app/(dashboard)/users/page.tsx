  ...
  const handleOpenCreateModal = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Plan usage bar */}
        {planInfo && (
          <div className={`rounded-2xl border p-4 flex items-center justify-between gap-4 ${isAtLimit
              ...
              <div className="flex items-center gap-4 bg-slate-950/60 p-3.5 rounded-2xl border border-slate-800">
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div
                    ...
                    className={`border-2 border-dashed rounded-xl p-3 text-center cursor-pointer transition-all ${isDragging
